  ...
  $.fn[pluginName] = function(options) {
    ...
    var Plugin = {
              ...
              if (typeof dataWidth !== 'undefined') {
                if (dataWidth === 'auto') {
                  ...
                  if (maxWidthList[field]) {
                    ...
                    width = maxWidthList[field] = Math.max.apply(
                      null,
                      $(cells)
                        .map(function() {
      ...
      rows: function(selector) {
        if (Plugin.isLocked()) {
          Plugin.nodeTr = Plugin.recentNode = t(datatable.tableBody)
            .find(selector)
            .filter(
      ...
      if (the.options.toggleBy) {
        if (typeof the.options.toggleBy === 'string') {
          ...
          for (var i in the.options.toggleBy) {
            KTUtil.addEvent(the.options.toggleBy[i].target, 'click', function(
              e
            ) {
              e.preventDefault()
              Plugin.toggle()
        ...
        if (e.target !== element && element.contains(e.target) === false) {
          ...
          if (
            (items = element.querySelectorAll(
              '.kt-menu__item--submenu.kt-menu__item--hover:not(.kt-menu__item--tabs)[data-ktmenu-submenu-toggle="click"]'
            ))
          ) {
